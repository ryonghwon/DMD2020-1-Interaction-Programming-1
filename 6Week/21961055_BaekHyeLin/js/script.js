...
var cars = ['Tesla', 'Audi', 'Volvo', 'Benz']; // cars 변수 선언, 배열.

cars.reverse(); // 원소의 순서 반대로 정렬.
...
var numbers = [-1, 2, 5, 10, 1, -10, 8, 4] // numbers 변수 선언, 숫자 타입의 원소값 배열.
...
var star1 = getStar("text"); // star1 변수 선언, getStar("text") 호출.
console.log(star1); // 숫자만 입력 가능합니다. // false

var star2 = getStar(5); // star2 변수 선언, getStar(5) 호출.
console.log(star2); // *****
...
fruit.unshift("Mango"); // 배열 객체의 첫 번째에 "Mango" 요소 추가.
// console.log(fruit); // ["Mango", "Apple", "Orange", "Grape", "Melon"]

fruit.splice(3, 0, "Cherry"); // "Orange" 요소 뒤에 "Cherry" 요소로 추가.
