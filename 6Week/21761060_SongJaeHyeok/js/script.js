...
*/
//getStar 함수를 선언하고 매개변수 지정
function getStar(_num){
    var ans2 = "";
    //매개변수가 숫자타입이 아니라면 console에 문구 출력을 하고 false를 반환한다
    if(typeof _num !== "number")
    {   
        console.log("숫자만 입력 가능합니다.");
        return false;
    }
    //매개변수가 숫자타입이면 반목문을 활용하여 매개변수의 수만큼 ans2에다 *가 반복하여 대입하고 반환한다.
    else if(typeof _num === "number"){
...
//star1 변수를 선언하고 getStar("text") 를 호출 후 반환값을 할당받아 결과값을 console 에 출력한다.
var star1 = getStar("text");
console.log(star1);
//star1 변수를 선언하고 getStar(5) 를 호출 후 반환값을 할당받아 결과값을 console 에 출력한다.
var star2 = getStar(5);
console.log(star2);
...
*/
//fruit 라는 변수를 선언하고 배열  ['Apple', 'Orange', 'Grape', 'Melon'] 대입
var fruit = ['Apple', 'Orange', 'Grape', 'Melon'];
//unshift를 이용하여 배열의 첫 원소값을 추가한다
fruit.unshift("Mango");
//splice를 이용하여 세번째자리에 원소값을 추가하고, 0개의 값을 삭제하고, Cherry를 추가한다
fruit.splice(3, 0, "Cherry");
//reverse를 이용하여 배열순서를 반대로 변경하고 console에 출력한다.
fruit.reverse();
console.log(fruit);