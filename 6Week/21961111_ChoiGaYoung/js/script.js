...
cars.reverse(); //reverse를 사용해서 순서를 반대로
...
console.log(Math.max.apply(null, numbers)); // 10, 가장 큰 숫자 max

console.log(Math.min.apply(null, numbers)); // -10, 가장 작은 숫자 min
