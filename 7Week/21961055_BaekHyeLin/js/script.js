...
console.log("윈도우 콘텐츠의 영역 width : " + winWidth + " px, height : " + winHeight + " px 입니다."); // 윈도우 콘텐츠의 영역 width : 982 px, height : 754 px 입니다. - 출력
...
console.log("row class의 개수는 " + rowCount + "개 입니다.");  // row class의 개수는 5개 입니다. - 출력
...
idArticle.lastElementChild.classList.remove("row");
