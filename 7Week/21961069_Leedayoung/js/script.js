...
document.title = '21961069_이다영';
// console.log(document.title); //21961069_이다영으로 변경되었습니다.
...
var scroll_ = document.getElementById('scroll');
scroll_.classList.add('scroll');
scroll_.scrollTo(400, 0); //x:400px, y: 0px로 이동.
...
var row1 = article1.firstElementChild;
row1.classList.add('red');
var row2 = article1.lastElementChild;
