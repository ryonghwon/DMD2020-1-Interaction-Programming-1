...
var newId = document.getElementById("title"); 
newId.innerText = "Hello World";
// console.log(newId); // <div id="title">Hello World</div>
...
*/
// Answer 4.
var newClass = document.getElementsByClassName("title");
newClass.innerText = "안녕하세요."
// console.log(newClass); // HTMLCollection(3) [div.title, div.title, div.title, "안녕하세요"]
for(var i = 0; i < newClass.length; i++){
    newClass[i].innerText = "안녕하세요.";
}
...
var newScroll = document.getElementById("scroll");
newScroll.classList.add("scroll");
newScroll.scrollTo(400, 0);
...
var findId = document.getElementById("article");
findId.firstElementChild.classList.add("red");

var findClass = findId.getElementsByClassName("row");
console.log(findClass); // length: 3 // removeChild 실행 후 length: 2
findId.removeChild(findClass[2]); // 
...
// var name = prompt("이름을 입력해주세요."); // 시스템 다이얼로그 창을 출력. (메시지 + 입력가능한 인풋, 확인 / 취소)
