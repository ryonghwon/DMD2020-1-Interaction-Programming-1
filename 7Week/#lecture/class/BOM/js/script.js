...
// }, 1000); // 1초마다 코드 실행.
// setInterval(call(handler), time); milliseconds - 1000/1 초(ms)
/*
var i = 0;
function loop(){
...
// console.log(navigator.userAgent); // 어떤 디바이스로 접촉했는지 체크할 때 사용.
// console.log(navigator.userAgent.match("Mac").length > 0); // Mac을 사용하고 있군..
// console.log(navigator.userAgent.match("Windows") !== null); // Windows를 사용하고 있군..
