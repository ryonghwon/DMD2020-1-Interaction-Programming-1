...
// title class 총 3개, for문 이용해보기.
for (var c = 0; c < class_title; c++) {
    class_title[c].innerText = "안녕하세요.";
    // [0] , [1], [2] 총 세 번의 class_title에 안녕하세요 문자열 표함.
}
...
var id_scorll = document.getElementById("scroll");
