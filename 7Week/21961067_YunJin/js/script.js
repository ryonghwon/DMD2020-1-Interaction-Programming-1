...
Classtitle.innerText = '안녕하세요.'; // 적용되지 않음 // 왜 그런건지 궁금합니다
...
Idarticle.firstElementChild.classList.add('red');
//Idarticle.lastElementChild.classList.remove('row'); // h2는 삭제되지 않음
var getrow = document.getElementsByClassName('row');
Idarticle.removeChild(getrow[4]); // 클래스 row 중에 4번째(마지막)을 지움
