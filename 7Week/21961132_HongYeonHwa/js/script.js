...
var winSize=getSize();
console.log("원도우 콘텐츠 영역 width :"+ winWidth +"px" "height :" +  winHeight +"px 입니다.")
...
*/
// Answer 3.
var id_tilttle =document.getElementById('title');
id_tilttle.innertext='Hello World';
...
for (var x =0; x<class_title.length; x++)
{
...
console.log("row class 개수는"+rowCount +"개 입니다");
...
var dell = id_article.getElementsByClassName("row");
id_article.removeChild(dell[2]);
