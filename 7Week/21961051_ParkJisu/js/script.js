...
function getRowCount(){
    class_row = document.getElementsByClassName("row");
    return;
}
var rowCount = getRowCount();
console.log("row class의 개수는 " + class_row.length +"개 입니다.");
...
id_scroll.scrollTo(400, 0); //숫자로 입력,
...
id_article.removeChild(remove[4]); // "article" id 위에 class="row"가 하나 더 있어서 4번째라고 하니까 세번째 요소가 사라졌습니다.
