...
var winSize = getSize();
console.log("윈도우 콘텐츠의 영역 width : " + winWith + " px , heihgt : " + winHeight + " px 입니다.");
...
function setTime(){
    _count = setTimeout(setLoop, 1000);
}
setTime();
...
idArticle.removeChild(classRow[2]);
