...
*/
// Answer 4.
var Class = document.getElementsByClassName("title");
for(var i = 0; i < Class.length; i++){
    Class[i].innerText = "안녕하세요.";
}
...
*/
// Answer 8.
var article01 = document.getElementById("article");

article.firstElementChild.classList.add("red");

var article02 = article01.getElementsByClassName("row");
article.removeChild(article02[2]);
