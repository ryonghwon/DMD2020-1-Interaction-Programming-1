...
// console.log(document.title); // 현재 문서 제목 7Week
document.title = "21861122_최성혜";
// console.log(document.title); // 21861122_최성혜
...
var winSize = getSize();
console.log("윈도우 콘텐츠의 영역 width : " + winWidth + "px, heigth : " + winHeight + "px 입니다.");
...
// console.log(classTitle); // 배열로 반환 됨을 확인
// console.log(classTitle[0]); // 첫번째 class 출력
// classTitle.innerText = "안녕하세요.";
// console.log(classTitle[0]); // 적용이 되지 않음.
// console.log(classTitle[2]); // 적용이 되지 않음.
// console.log(classTitle); // 문자열이 배열의 일부로서 포함 되었음.
// classTitle[0].innerText = "안녕하세요";
// console.log(classTitle[0]); // 문자열이 포함되었다.
// 반복문을 이용하여 작성
for (var i = 0; i < classTitle.length; i++) {
    classTitle[i].innerText = "안녕하세요";
    // console.log(classTitle[i]);
...
// console.log(idScroll.classList);
idScroll.classList.add("scroll");
// console.log(idScroll);
// var classScroll = document.getElementsByClassName("scroll")
...
var idArRow = idAr.firstElementChild;
idArRow.classList.add("red");
var idArlaR = idAr.lastElementChild;
idAr.removeChild(idArlaR);
// console.log(idAr.children);
