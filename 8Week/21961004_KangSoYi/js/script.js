...
*/
// Answer 1.
var buttonSnum = document.getElementById("btn-student-number");

buttonSnum.addEventListener("click",onClickbuttonSnum);

function onClickbuttonSnum(event) {
    event.preventDefault();
    buttonSnum.textContent = "21961004";
    window.alert("학번이 입력되었습니다.");
} 
//console.log(buttonSnum);

var buttonSname = document.getElementById("btn-student-name");

buttonSnum.addEventListener("click",onClickbuttonSname);

function onClickbuttonSname(event) {
    event.preventDefault();
    buttonSname.textContent = "강소이";
...
var winH = innerHeight, winW = innerWidth;

var windowSize = document.getElementById("btn-window-size");

windowSize.addEventListener("click",onClickwindowSize);

function onClickwindowSize(event) {
    event.preventDefault();
...
var checkId = document.getElementById("btn-check-id");

checkId.addEventListener("click",onClickcheckId);

function onClickcheckId (event) {
    event.preventDefault();
    var uId = document.getElementById("user_id");
    var uIdAttri = uId.value;
    console.log("input#user_id - value 속성 값의 문자열 개수는" + uIdAttri.length+ "입니다."); 
}
...
cancel.addEventListener("click",onClickcacel);

function onClickcacel(event) {
    event.preventDefault();
    location.reload();
}
...
function onClickreset(event) {
    event.preventDefault();
    var num100 = prompt("초기화하시려면 100을 입력하세요.");
    if (num100 == 100) {
        uId.setAttribute("value", "");
        uPass.setAttribute("value", "");
    }
    //console.log(uId.getAttribute("value"));
    //console.log(uPass.getAttribute("value"));
}
...
odd.addEventListener("click", onClickodd);
...
var addCity = document.getElementById("btn-add-city");
var cityList = document.getElementById("city-list");

addCity.addEventListener("click",onClickaddCity);
...
var buttonColor = document.getElementById("btn-color");
var sentence = document.getElementsByClassName("sentence");
var click = 0;

buttonColor.addEventListener("click",onClickbuttonColor);
...
var topButton = document.getElementById("btn-go-top");
