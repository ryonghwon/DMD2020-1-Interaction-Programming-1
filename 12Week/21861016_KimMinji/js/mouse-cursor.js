...
btnListEls = Array.prototype.slice.call(btnListEls); // 노드 목록을 배열로 사용 가능하도록 치환한다.
function onMouseMove(e) {
    // console.log(e.clientX, e.clientY);
    // console.log(e.pageX, e.pageY);
    // 마우스의 좌표를 받아올 수 있다.
    // client - 브라우저를 기준으로 마우스 좌표를 찾아온다. (스크롤이 되어도 같은 값 - 현재 보이는 브라우저의 고정 값)
    ...
    */
    ...
    gsap.to(cursorBGEl, {top: posY, left: posX, duration: 0.3, ease: "circ.out"});
    gsap.to(progressEl, {top: posY, left: posX, duration: 0.25, ease: "circ.out"});
}
