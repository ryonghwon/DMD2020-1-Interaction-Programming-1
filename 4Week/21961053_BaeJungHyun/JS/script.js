...
function compareNumbers(a,b) {
  ...
  compareNumbers(10); // 호출한 경우 : "두번째 매개변수의 값을 찾을 수 없습니다."
  compareNumbers(20, 10); // 호출한 경우 : "첫번째 매개변수에 할당된 전달인자의 값이 두번째 매개변수에 할당된 전달인자의 값보다 크거나 같습니다."
  compareNumbers(10, 20); // 호출한 경우 : "첫번째 매개변수에 할당된 전달인자의 값이 두번째 매개변수에 할당된 전달인자의 값보다 작습니다."
  ...
  */
  ...
  /* 조건 1-2를 진행할때에 변수 sum이 0인 상태라 값이 계속 0으로 나왔습니다,,,
  ...
  */
  ...
  console.log(getMaxValue([10, -4, 7, 100, "hello", -50])); //3
  console.log(getMaxValue([-400, "world", 60, 0, {}, 1000])); //5
  */
