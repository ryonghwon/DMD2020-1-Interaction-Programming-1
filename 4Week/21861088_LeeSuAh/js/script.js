...
var result = getTotal(10, "add"); // 55
console.log(result);
var result = getTotal(20, "add"); // 210
console.log(result);
var result = getTotal(7, "multiply"); // 5040
console.log(result);
var result = getTotal(10, "multiply"); //3628800
console.log(result);
var result = getTotal(300); // 0
console.log(result);
...
var end = getMaxValue(arr1);
console.log(end);
var end = getMaxValue(arr2);
console.log(end);
