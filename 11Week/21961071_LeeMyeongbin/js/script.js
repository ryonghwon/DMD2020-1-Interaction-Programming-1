...
// var gnbTabEl = document.querySelector("#gnb"),
//     btngnbMenuEls = tabMenuEl.querySelectorAll("a"),
//     gnbContentEls = document.querySelectorAll(".content"),
//     cuId = 0,
//     // exId = null;
//     exId = cuId;
// gnbTabMenuEls = Array.prototype.slice.call(gnbTabMenuEls); // 배열로 변경.

// function onClickGNB(e){
//     e.preventDefault();
//     var el = e.currentTarget, index = btngnbMenuEls.indexOf(el);
//     if(!el.classList.contains("selected")) {
//         btngnbMenuEls[exId].classList.remove("selected");
//         gnbContentEls[exId].classList.remove("selected");
//         cuId = index;
//         el.classList.add("selected");
//         gnbTabEl[cuId].classList.add("selected");
//         exId = cuId;
//     }
// }
// for (var i = 0; i < btngnbMenuEls.length; i++) {
//     btngnbMenuEls[i].addEventListener("click", onClickGNB);
// }